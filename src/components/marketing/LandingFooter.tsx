        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            <Link href="/" className="flex items-center gap-3 group inline-flex">
              ...
              <span className="font-extrabold text-2xl text-white tracking-tight">WargaLink</span>
            </Link>
            <p className="text-slate-400 leading-relaxed text-sm">
              Platform digital terintegrasi untuk mempermudah birokrasi, keuangan, dan komunikasi warga di tingkat RT/RW seluruh Indonesia.
            </p>
          ...
          {/* Navigasi */}
          <div>
            <h3 className="text-white font-bold mb-6 text-lg tracking-wide">Navigasi</h3>
          ...
          {/* Legal */}
          <div>
            <h3 className="text-white font-bold mb-6 text-lg tracking-wide">Legalitas</h3>
            <ul className="space-y-4 text-sm font-medium">
              ...
              <li><a href="#" className="hover:text-emerald-400 transition-colors">Perlindungan Data</a></li>
              <li><a href="#" className="hover:text-emerald-400 transition-colors">SLA Layanan</a></li>
            </ul>
          </div>

          {/* Kontak */}
          <div>
            <h3 className="text-white font-bold mb-6 text-lg tracking-wide">Hubungi Kami</h3>
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-emerald-500 shrink-0 mt-0.5" />
                <span>Gedung WargaLink Lt. 4<br/>Jl. Sudirman No. 123, Jakarta</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span>halo@wargalink.id</span>
              </li>
            </ul>
          </div>
        </div>

        <div className="pt-8 border-t border-slate-800/50 text-sm flex flex-col md:flex-row justify-between items-center gap-4">
          <p>&copy; {new Date().getFullYear()} PT WargaLink Teknologi Indonesia. Hak cipta dilindungi.</p>
          <p className="flex items-center gap-1 font-medium">
            Dibuat dengan <span className="text-red-500">❤️</span> untuk Indonesia
          </p>
        </div>
      </div>
    </footer>
